...
def build_file_tree(directory):
    ...
    for root, dirs, files in os.walk(directory, topdown=True):
        ...
        if relative_path == '.':
            ...
            if root_section_name not in tree_root:
                tree_root[root_section_name] = {'type': 'folder', 'name': root_section_name, 'children': []}
            
            current = tree_root[root_section_name]
    ...
    if root_section_name in tree_root and not tree_root[root_section_name]['children']:
        del tree_root[root_section_name]
